...
import { convertToUnit, getBestUnitForRange, formatEnergy } from './units';
...
function DailyEnergyChart({ dailyLoadData, analysisData }) {
    ...
    const allValues = rawData.flatMap(d => [d.avg_energy, d.peak_energy]);
    const bestUnit = getBestUnitForRange(allValues);

    // Convert all data to the best unit
    const chartData = rawData.map(d => ({
        day: d.day,
        avg_energy: convertToUnit(d.avg_energy, bestUnit),
        peak_energy: convertToUnit(d.peak_energy, bestUnit),
            ...
            return (
                <div className="custom-tooltip">
                    ...
                    <p className="value" style={{ color: '#EF4444' }}>
                        Peak: {formatEnergy(data.original_peak_gj)}
                    </p>
                </div>
            );
        }
            ...
            <div className="energy-stats">
                ...
                <div className="stat-cards">
                    <div className="stat-card">
                        ...
                        <div className="stat-value">{formatEnergy(peakHourlyEnergy)}</div>
                        {peakHourlyTime && (
